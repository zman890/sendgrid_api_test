...
And I fill in the 'to' field with 'jdzman@gmail.com' 
And I fill in the 'toname' field with 'Justin Zimmerman' 
And I fill in the 'x-smtpapi' field with '{"filters" : {"clicktrack" : {"settings" : {"enable" : 1}}}}'
And I fill in the 'from' field with 'jdzman@gmail.com'
And I fill in the 'fromname' field with 'Justin Zimmerman'
...
And I fill in the 'bcc' field with 'jdzman@gmail.com'
